...
public class ShadowTests {
	...
	public void SphereTriangleMove1() {
		...
		scene.addLights(new SpotLight( new Color(400, 240, 0),new Point3D(-100, 100, -200),
				new Vector(1, -1, 3), 1, 0.000001, 0.00000001));
	...
	public void SphereTriangleMove2() {
		...
		scene.addLights(new SpotLight(new Color(400, 240, 0),new Point3D(-100, 100, -200),new Vector(1, -1, 3),  1, 0.000001, 0.00000001));
	...
	public void SphereTriangleSpot1() {
		...
		scene.addLights(new SpotLight(new Color(500, 300, 0), new Point3D(-85, 85, -125),
				new Vector(1, -1, 3),1, 0.000001, 0.00000001
				));
	...
	public void SphereTriangleSpot2() {
		...
		scene.addLights(new SpotLight(new Color(700, 400, 400),new Point3D(40, -40, -115),
				new Vector(-1, 1, 4),  1, 0.000001, 0.00000001
				));

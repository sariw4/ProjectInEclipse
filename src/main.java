...
//sari weiss 315120568 sariw4309090@gmail.com
//naama liberman 206831885 namliber@gmail.com
/**
 * Test program for the 1st stage
 *
 * @authorDanZilberstein
 */
public final class main {
    ...
    public static void main(String[] args) {
        ...
        if (!new Vector(1.0, 1.0, 1.0).equals(new Point3D(2.0, 3.0, 4.0).subtract(p1)))
